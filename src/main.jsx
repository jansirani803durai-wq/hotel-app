...
const img = (name) => assetMap[`./assets/${name}`] || '';
const assetName = (path) => String(path || '').split('/').pop();
const roomImage = (path) => img(assetName(path)) || path;
